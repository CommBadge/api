...
func TestAuthURL_IncludesPKCEParams(t *testing.T) {
	c := NewClient(&Config{ClientID: "cid", ClientSecret: "secret", RedirectURL: "http://localhost:8080/auth/callback", BaseURL: "https://discord.com"})
...
func TestExchange_SendsCodeVerifier(t *testing.T) {
	...
	c := NewClient(&Config{ClientID: "cid", ClientSecret: "secret", RedirectURL: "http://localhost:8080/auth/callback", BaseURL: srv.URL})
